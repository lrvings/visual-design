import { isActive, isExternal, normalize } from 'vitepress/dist/client/shared'
import type { Route } from 'vitepress'

export * from './colors'

export { isExternal, isActive, normalize } from 'vitepress/dist/client/shared'
...
export function createGitHubUrl(
  ...
  return `${base.replace('', '')}/edit/${docsBranch}/${
